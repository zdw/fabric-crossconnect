...
class TestKubernetesEvent(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fcservice = FabricCrossconnectService(name="myfcservice",
                                                   id=1112,
                                                   backend_code=1,
                                                   backend_status="succeeded",
                                                   provider_services=[self.onos])

        self.fcsi1 = FabricCrossconnectServiceInstance(name="myfcsi1",
                                                       owner=self.fcservice,
                                                       backend_code=1,
                                                       backend_status="succeeded")

        self.fcsi2 = FabricCrossconnectServiceInstance(name="myfcsi2",
                                                       owner=self.fcservice,
                                                       backend_code=1,
                                                       backend_status="succeeded")
